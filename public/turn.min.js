...
;(function (h) {
    var x,
        ...
        J = { backward: ["bl", "tl"], forward: ["br", "tr"], all: ["tl", "bl", "tr", "br"] },
        O = ["single", "double"],
        P = { page: 1, gradients: !0, duration: 600, acceleration: !0, display: "double", when: null },
        Q = { folding: null, corners: "forward", cornerSize: 100, gradients: !0, duration: 600, acceleration: !0 },
        K = {
        ...
        L = function (a, b, c, d, e) {
            var f = 1 - e,
                ...
                i = e * e * e
            return j(
                Math.round(C * a.x + 3 * e * f * f * b.x + 3 * e * e * f * c.x + i * d.x),
                Math.round(C * a.y + 3 * e * f * f * b.y + 3 * e * e * f * c.y + i * d.y)
            )
        },
        j = function (a, b) {
            return { x: a, y: b }
        ...
        M = function (a, b, c, d, e) {
            var f,
                C = []
            if ("-webkit-" == y) {
                for (f = 0; f < e; f++) C.push("color-stop(" + d[f][0] + ", " + d[f][1] + ")")
                a.css({
                    "background-image":
                ...
                for (f = 0; f < e; f++) C.push(" " + d[f][1] + " " + (100 * (b + i * d[f][0])) / g + "%")
                a.css({ "background-image": y + "linear-gradient(" + -h + "rad," + C.join(",") + ")" })
            }
        },
        g = {
            init: function (a) {
                void 0 === x &&
                    ((x = "WebKitCSSMatrix" in window || "MozPerspective" in document.body.style), (y = R()))
                var b,
                    c = this.data(),
                    d = this.children(),
                    a = h.extend({ width: this.width(), height: this.height() }, P, a)
                c.opts = a
                c.pageObjs = {}
                c.pages = {}
                c.pageWrap = {}
                ...
                if (a.when) for (b in a.when) p(b, a.when) && this.bind(b, a.when[b])
                ...
                h(this).bind(I.start, function (a) {
                    for (var b in c.pages)
                        if (p(b, c.pages) && i._eventStart.call(c.pages[b], a) === false) return false
                })
                h(document)
                    .bind(I.move, function (a) {
                        for (var b in c.pages) p(b, c.pages) && i._eventMove.call(c.pages[b], a)
                    })
                    .bind(I.end, function (a) {
                        for (var b in c.pages) p(b, c.pages) && i._eventEnd.call(c.pages[b], a)
                    })
                c.done = !0
                return this
            },
            addPage: function (a, b) {
                ...
                if (b)
                    if (b == e) ((b = e), (c = !0))
                        ...
                        if (b > e)
                            throw Error(
                                'It is impossible to add the page "' + b + '", the maximum value is: "' + e + '"'
                            )
                    }
                else ((b = e), (c = !0))
                1 <= b &&
                    b <= e &&
                    (d.done && this.turn("stop"),
                    b in d.pageObjs && g._movePages.call(this, b, 1),
                    c && (d.totalPages = e),
                    (d.pageObjs[b] = h(a).addClass("turn-page p" + b)),
                    g._addPage.call(this, b),
                    d.done && this.turn("update"),
                    ...
                    if (g._necessPage.call(this, a)) {
                        if (!b.pageWrap[a]) {
                            var d = "double" == b.display ? this.width() / 2 : this.width(),
                                e = this.height()
                            c.css({ width: d, height: e })
                            b.pagePlace[a] = a
                            b.pageWrap[a] = h("<div/>", {
                                class: "turn-page-wrapper",
                                page: a,
                                css: { position: "absolute", overflow: "hidden", width: d, height: e }
            ...
            _makeFlip: function (a) {
                ...
                if (!b.pages[a] && b.pagePlace[a] == a) {
                    ...
                    b.pages[a] = b.pageObjs[a]
                        .css({ width: c ? this.width() : this.width() / 2, height: this.height() })
                        .flip({
                            page: a,
                        ...
                        .bind("pressed", g._pressed)
                        .bind("released", g._released)
                        .bind("start", g._start)
                        .bind("end", g._end)
                        .bind("flip", g._flip)
                }
            ...
            range: function (a) {
                ...
                if (1 > a || a > d.totalPages) throw Error('"' + a + '" is not a page for range')
                e[1] = e[1] || e[0]
                1 <= e[0] && e[1] <= d.totalPages
                    ? ((a = Math.floor(2)),
                      d.totalPages - e[1] > e[0]
                          ? ((b = Math.min(e[0] - 1, a)), (c = 2 * a - b))
                          : ((c = Math.min(d.totalPages - e[1], a)), (b = 2 * a - c)))
                    : (c = b = 5)
            ...
            removePage: function (a) {
                ...
                b.pageObjs[a] &&
                    ...
                    b.page > b.totalPages && this.turn("page", b.totalPages))
                return this
            },
                ...
                var c,
                    ...
                    f = function (a) {
                        ...
                        d.pagePlace[a] &&
                            d.pageWrap[a] &&
                            ((d.pagePlace[c] = c),
                            (d.pageWrap[c] = d.pageWrap[a].css(K[e ? 0 : f]).attr("page", c)),
                            d.pages[a] &&
                                (d.pages[c] = d.pages[a].flip("options", {
                                    page: c,
                                    next: e || f ? c + 1 : c - 1,
                            ...
                            b &&
                                (delete d.pages[a],
                                delete d.pagePlace[a],
                                delete d.pageObjs[a],
                                delete d.pageWrap[a],
                                delete d.pageObjs[a]))
                    }
                if (0 < b) for (c = d.totalPages; c >= a; c--) f(c)
                else for (c = a; c <= d.totalPages; c++) f(c)
            },
            display: function (a) {
                var b = this.data(),
                    c = b.display
                if (a) {
                    if (-1 == h.inArray(a, O)) throw Error('"' + a + '" is not a value for display')
                    "single" == a
                        ? b.pageObjs[0] ||
                          (this.turn("stop").css({ overflow: "hidden" }),
                          (b.pageObjs[0] = h("<div />", { class: "turn-page p-temporal" })
                              .css({ width: this.width(), height: this.height() })
                              .appendTo(this)))
                        : b.pageObjs[0] &&
                          (this.turn("stop").css({ overflow: "" }), b.pageObjs[0].remove(), delete b.pageObjs[0])
                    b.display = a
                    c &&
                        ((a = this.turn("size")),
            ...
            disable: function (a) {
                ...
                for (b in c.pages) p(b, c.pages) && c.pages[b].flip("disable", a ? h.inArray(b, d) : !1)
                return this
            },
            size: function (a, b) {
                if (a && b) {
                    ...
                    c.pageObjs[0] && c.pageObjs[0].css({ width: d, height: b })
                    for (e in c.pageWrap)
                        p(e, c.pageWrap) &&
                            (c.pageObjs[e].css({ width: d, height: b }),
                            c.pageWrap[e].css({ width: d, height: b }),
                            c.pages[e] && c.pages[e].css({ width: d, height: b }))
                    this.turn("resize")
                    return this
                }
            ...
            stop: function () {
                ...
                for (a in d)
                    p(a, d) &&
                        ((b = c.pages[d[a]].data().f.opts),
                        i._moveFoldingPage.call(c.pages[d[a]], null),
                        c.pages[d[a]].flip("hideFoldedPage"),
                        (c.pagePlace[b.next] = b.next),
                        b.force && ((b.next = 0 === b.page % 2 ? b.page - 1 : b.page + 1), delete b.force))
                this.turn("update")
                return this
            },
            pages: function (a) {
            ...
            _fitPage: function (a, b) {
                var c = this.data(),
                    d = this.turn("view", a)
                c.page != a &&
                    (this.trigger("turning", [a, d]),
                    -1 != h.inArray(1, d) && this.trigger("first"),
                    -1 != h.inArray(c.totalPages, d) && this.trigger("last"))
                c.pageObjs[a] &&
                    ((c.tpage = a),
                    this.turn("stop", b),
                    g._removeFromDOM.call(this),
                    g._makeRange.call(this),
                    this.trigger("turned", [a, d]))
            },
            _turnPage: function (a) {
                var b,
                    ...
                    f = this.turn("view", a)
                d.page != a &&
                    (this.trigger("turning", [a, f]),
                    -1 != h.inArray(1, f) && this.trigger("first"),
                    -1 != h.inArray(d.totalPages, f) && this.trigger("last"))
                if (
                    d.pageObjs[a] &&
                    ((d.tpage = a),
                    this.turn("stop"),
                    ...
                    ((a = d.pages[b].data().f.opts),
                        ...
                        "single" == d.display
                            ? d.pages[b].flip("turnPage", f[0] > e[0] ? "br" : "bl")
                            : d.pages[b].flip("turnPage"))
            },
            page: function (a) {
                var a = parseInt(a, 10),
                    b = this.data()
                return 0 < a && a <= b.totalPages
                    ? (!b.done || -1 != h.inArray(a, this.turn("view"))
            ...
            _start: function (a, b, c) {
                ...
                e.isDefaultPrevented()
                    ...
                    : ("single" == d.display &&
                          ((c = "l" == c.charAt(1)),
                          (1 == b.page && c) || (b.page == d.totalPages && !c)
                              ? a.preventDefault()
                              : c
                                ? ((b.next = b.next < b.page ? b.next : b.page - 1), (b.force = !0))
                                : (b.next = b.next > b.page ? b.next : b.page + 1)),
                      g._addMotionPage.call(this))
            },
            _end: function (a, b) {
                ...
                if (b || e.tpage) {
                    if (e.tpage == c.next || e.tpage == c.page)
                        (delete e.tpage, g._fitPage.call(d, e.tpage || c.next, !0))
                } else (g._removeMv.call(d, c.pageMv), d.turn("update"))
            },
            _pressed: function () {
                var a,
                    b = h(this).data().f,
                    c = b.opts.turn.data().pages
                for (a in c) a != b.opts.page && c[a].flip("disable", !0)
            ...
            _released: function (a, b) {
                var c = h(this),
                    d = c.data().f
                a.stopPropagation()
                if (200 > new Date().getTime() - d.time || 0 > b.x || b.x > h(this).width())
                    (a.preventDefault(),
            ...
            update: function () {
                ...
                if (b.pageMv.length && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap)
                        p(a, b.pageWrap) &&
                            (b.pageWrap[a].css({ display: c.pageV[a] ? "" : "none", "z-index": c.pageZ[a] || 0 }),
                            b.pages[a] &&
                                (b.pages[a].flip("z", c.partZ[a] || null),
                                c.pageV[a] && b.pages[a].flip("resize"),
                                b.tpage && b.pages[a].flip("disable", !0)))
                } else
                    for (a in b.pageWrap)
                        p(a, b.pageWrap) &&
                            ((c = g._setPageLoc.call(this, a)),
                            b.pages[a] && b.pages[a].flip("disable", b.disabled || 1 != c).flip("z", null))
            },
            _setPageLoc: function (a) {
                var b = this.data(),
                    c = this.turn("view")
                if (a == c[0] || a == c[1]) return (b.pageWrap[a].css({ "z-index": b.totalPages, display: "" }), 1)
                if (
                    ("single" == b.display && a == c[0] + 1) ||
                    ("double" == b.display && a == c[0] - 2) ||
                    a == c[1] + 2
                )
                    return (b.pageWrap[a].css({ "z-index": b.totalPages - 1, display: "" }), 2)
                b.pageWrap[a].css({ "z-index": 0, display: "none" })
                return 0
            }
        },
        i = {
            ...
            options: function (a) {
                var b = this.data().f
                return a ? (i.setData.call(this, { opts: h.extend({}, b.opts || Q, a) }), this) : b.opts
            },
            z: function (a) {
                var b = this.data().f
                b.opts["z-index"] = a
                b.fwrapper.css({ "z-index": a || parseInt(b.parent.css("z-index"), 10) || 0 })
                return this
            },
            _cAllowed: function () {
            ...
            _cornerActivated: function (a) {
                ...
                var a = q ? a.originalEvent.touches : [a],
                    ...
                    d = this.width(),
                    e = this.height(),
                    a = { x: Math.max(0, a[0].pageX - c.left), y: Math.max(0, a[0].pageY - c.top) },
                    b = b.opts.cornerSize,
            ...
            _backGradient: function () {
                ...
                if (
                    (b =
                        a.opts.backGradient &&
                        (!b ||
                            "single" == b.data().display ||
                            (2 != a.opts.page && a.opts.page != b.data().totalPages - 1))) &&
                    !a.bshadow
                )
                    a.bshadow = h("<div/>", l(0, 0, 1))
            ...
            resize: function (a) {
                ...
                a &&
                    (b.wrapper.css({ width: e, height: e }),
                    b.fwrapper.css({ width: e, height: e }).children(":first-child").css({ width: c, height: d }),
                    b.fpage.css({ width: d, height: c }),
                    b.opts.frontGradient && b.ashadow.css({ width: d, height: c }),
                    i._backGradient.call(this) && b.bshadow.css({ width: c, height: d }))
                b.parent.is(":visible") &&
                    (b.fwrapper.css({ top: b.parent.offset().top, left: b.parent.offset().left }),
                    b.opts.turn && b.fparent.css({ top: -b.opts.turn.offset().top, left: -b.opts.turn.offset().left }))
            ...
            _addPageWrapper: function () {
                ...
                if (!a.wrapper) {
                    ...
                    a.fparent ||
                        ((c = h("<div/>", { css: { "pointer-events": "none" } }).hide()),
                        (c.data().flips = 0),
                        a.opts.turn
                            ? (c
                                  .css(l(-a.opts.turn.offset().top, -a.opts.turn.offset().left, "auto", "visible").css)
                                  .appendTo(a.opts.turn),
                              (a.opts.turn.data().fparent = c))
                            : c
                                  .css(l(0, 0, "auto", "visible").css)
                                  .attr("id", "turn-fwrappers")
                                  .appendTo(h("body")),
                        (a.fparent = c))
                    this.css({ position: "absolute", top: 0, left: 0, bottom: "auto", right: "auto" })
                    a.wrapper = h("<div/>", l(0, 0, this.css("z-index")))
                        .appendTo(b)
                        .prepend(this)
                    a.fwrapper = h("<div/>", l(b.offset().top, b.offset().left)).hide().appendTo(a.fparent)
                    a.fpage = h("<div/>", { css: { cursor: "default" } }).appendTo(
                        h("<div/>", l(0, 0, 0, "visible")).appendTo(a.fwrapper)
                    )
            ...
            _fold: function (a) {
                ...
                var o = this.data().f,
                    ...
                    F = function () {
                        ...
                        if (
                            d > E &&
                            ((k.x += Math.abs(k.y * Math.tan(B))), (k.y = 0), Math.round(k.x * Math.tan(G - d)) < u)
                        )
                        ...
                        if (
                            ...
                            ((m = G - d),
                            (B = y - u / Math.sin(m)),
                            (n = j(Math.round(B * Math.cos(m)), Math.round(B * Math.sin(m)))),
                            A && (n.x = -n.x),
                            D)
                        )
                            n.y = -n.y
                        ...
                        H = m < r ? m / r : 1
                        if (
                            o.opts.frontGradient &&
                            ((g = 100 < v ? (v - 100) / v : 0),
                            (f = j(100 * ((v * Math.sin(E - d)) / u), 100 * ((v * Math.cos(E - d)) / r))),
                            D && (f.y = 100 - f.y),
                            A)
                        )
                            f.x = 100 - f.x
                        if (
                            i._backGradient.call(b) &&
                            ((h = j(100 * ((v * Math.sin(d)) / r), 100 * ((v * Math.cos(d)) / u))),
                            A || (h.x = 100 - h.x),
                            !D)
                        )
                            h.y = 100 - h.y
                    ...
                    x = function (a, c, e, k) {
                        var l = ["0", "auto"],
                            v = ((r - y) * e[0]) / 100,
                            q = ((u - y) * e[1]) / 100,
                            c = { left: l[c[0]], top: l[c[1]], right: l[c[2]], bottom: l[c[3]] },
                            l = 90 != k && -90 != k ? (A ? -1 : 1) : 0,
                            e = e[0] + "% " + e[1] + "%"
                        b.css(c).transform(t(k) + s(a.x + l, a.y, w), e)
                        o.fpage.parent().css(c)
                        o.wrapper.transform(s(-a.x + v - l, -a.y + q, w) + t(-k), e)
                        ...
                        o.opts.frontGradient &&
                            M(
                                ...
                                [
                                    [g, "rgba(0,0,0,0)"],
                                    [0.8 * (1 - g) + g, "rgba(0,0,0," + 0.2 * H + ")"],
                                    [1, "rgba(255,255,255," + 0.2 * H + ")"]
                                ],
                                3,
                                d
                            )
                ...
                if (c)
                    if (a) {
                        if (!b.fpage.children()[b.ashadow ? "1" : "0"])
                            (i.setData.call(this, { backParent: c.parent() }), b.fpage.prepend(c))
            ...
            turnPage: function (a) {
                var b = this,
                    c = this.data().f,
                    a = { corner: c.corner ? c.corner.corner : a || i._cAllowed.call(this)[0] },
            ...
            _eventStart: function (a) {
                ...
                if (!b.disabled && !this.flip("isTurning")) {
                    ...
                    if (b.corner && i._foldingPage.call(this, b.corner))
                        return (i._moveFoldingPage.call(this, !0), this.trigger("pressed", [b.point]), !1)
                    b.corner = null
                }
            },
            _eventMove: function (a) {
                ...
                if (!b.disabled)
                    if (((a = q ? a.originalEvent.touches : [a]), b.corner)) {
                        ...
                        !this.data().effect &&
                            this.is(":visible") &&
                            ((a = i._cornerActivated.call(this, a[0]))
            ...
            if (a) {
                ...
                var c,
                    ...
                    g = function () {
                        ...
                        for (c = 0; c < e; c++) g.push(a.easing(1, i, a.from[c], d[c], a.duration))
                        a.frame(e == 1 ? g[0] : g)
                        if (i == a.duration) {
